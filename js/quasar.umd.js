  ...
  */
      ...
      menuEvents: function menuEvents () {
        ...
        return {
          'before-show': function () {
            this$1.validated = false; // eslint-disable-line
            this$1.initialValue = clone$1(this$1.value); // eslint-disable-line
            this$1.watcher = this$1.$watch('value', this$1.__reposition); // eslint-disable-line
      ...
      allRowsSelected: function allRowsSelected () {
        ...
        if (this.multipleSelection === true) {
          return this.computedRows.length > 0 &&
            this.computedRows.every(function (row) { return this$1.selectedKeys[ this$1.getRowKey(row) ] === true; })
        }
      },
  ...
  var DialogPlugin = Vue.extend({
    ...
    computed: {
      ...
      optionsEvents: function optionsEvents () {
        var this$1 = this;
