    ...
    methods: {
        ...
        OnFadeInEnter()
        {
            ...
            if (v && !XR.vrMouseUI && false)
            {
                v.style = "width:100%;height:100%";
                v.play();
                XR.DebugToHtml("projectvideolayer Play");
            } else
            {
                this.FadeOut();
            }
        ...
        OnFadeOutEnd()
        {
            loadingpage.FadeIn(() =>
            {
                /* XR.LoadSceneLoop(["main", "A1", "A2", "b", "C_D", "E", "KP_XP", "NDX", "PG_GQ", "ww_dx", "ww_dx_JRBK", "ww_dx_WWBK", "ww_jz", "美术关卡", "Night"],
                    "", "", XR.CallBack("JsRun", 'XR.SetActiveSceneInstance("main");setTimeout(() => { loadingpage.FadeOut();}, 2000);mainpage.FadeIn();mediapage.FadeIn(); ')); */
                XR.LoadSceneLoop(["main", "美术关卡", "Night"],
                    "", "", XR.CallBack("JsRun", 'XR.SetActiveSceneInstance("main");setTimeout(() => { loadingpage.FadeOut();}, 2000);mainpage.FadeIn();mediapage.FadeIn(); '));
            }
            );
        },
...
let xfpage = new Vue({
    ...
    methods:
    {
        ...
        OnSelectRoom(jsonObject)
        {
            ...
            let stringSplit = jsonObject.room.split("-");
            this.buildInfo = stringSplit[0];
            this.unitInfo = stringSplit[1];
            this.roomNum = stringSplit[2];
